...
public class JoystickEditor : Editor
{
    ...
    protected SerializedProperty fakeImage;
    ...
    protected virtual void OnEnable()
    {
        ...
        fakeImage = serializedObject.FindProperty("fakeImage");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(fakeImage, new GUIContent("Fake Image", "my fake joystick"));
    }
